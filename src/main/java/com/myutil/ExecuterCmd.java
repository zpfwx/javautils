...
public class ExecuterCmd implements Runnable {
    final File file;
    final URL url;
     ...
     * Returns immediately.
     */
    public ExecuterCmd(File file, String command) {
        this.url = null;
        this.file = file;
     ...
     */
    public ExecuterCmd(URL url, String command) {
        this.url = url;
        this.file = null;
        this.command = command;
    }
     ...
     */
    public ExecuterCmd(String command) {
        this.url = null;
        this.file = null;
        this.command = command;
    }
